            ...
            @auth
                @if (auth()->user()->role === 'teacher')
                    <button class="btn btn-primary rounded-circle d-flex align-items-center justify-content-center"
                        style="width: 44px; height: 44px;" data-bs-toggle="modal" data-bs-target="#uploadModal"
                        title="Add Book">
    ...
    <script>
        ...
        function loadBooksByGrade() {
            ...
            if (!selectedGrade) {
                ...
                gradeLevelSections.innerHTML =
                    '<p class="text-muted text-center mt-4">Please select a grade level to view books.</p>';
                return;
            }
            ...
            fetch("/books")
                ...
                .then(data => {
                    ...
                    if (filteredBooks.length === 0) {
                        gradeLevelSections.innerHTML =
                            `<p class="text-muted text-center mt-4">No books found for ${selectedGrade}.</p>`;
                        return;
                    }
                    ...
                    gradeSection.innerHTML =
                        `<h3>${selectedGrade}</h3><div class="books-grid" id="books-grid-${selectedGrade.replace(/\s/g, '-')}"></div>`;
                ...
                .then(data => {
                    ...
                    if (data.lessons && data.lessons.length > 0) {
                        ...
                        data.lessons.forEach(lesson => {
                            ...
                            lessonDiv.className =
                            'lesson-item d-flex align-items-center'; // Added d-flex and align-items-center
                            lessonDiv.innerHTML = `
        ...
        function toggleVisibility(id, buttonElement) {
            ...
            if (el) {
                ...
                if (el.style.display === 'none' || el.style.display === '') {
                    ...
                    const unitToggleButton = buttonElement.closest('.d-flex').querySelector(
