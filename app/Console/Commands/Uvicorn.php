...
$$/   $$/  $$$$$$/  $$/       $$/  $$/  $$/  $$$$$$$/ $$/ 
        ...
        $fastApiApps = [
            ...
            [
                ...
                'file_and_app_instance' => 'paolo:app', // e.g., if you have main.py and `app = FastAPI()`
                'port' => 8004
            ],
            [
            ...
            // 
            // [
            //     'name' => 'Thank you note API',
            //     'path' => base_path('python\Thank You Note'), // Directory where your Python file is
