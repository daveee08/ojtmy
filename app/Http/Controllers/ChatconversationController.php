...
class ChatconversationController extends Controller
{
    ...
    {
        $response = Http::get("http://192.168.50.10:8003/chat/history/{$session_id}");
    ...
    public function sendMessage(Request $request)
    {
        ...
        $response = Http::asMultipart()
            ->timeout(0)
            ->post('http://192.168.50.10:8003/chat', $formData);
    ...
    public function getUserSessions(Request $request)
    {
        ...
        try {
            ...
            $response = Http::get("http://192.168.50.10:8003/sessions/{$userId}");
