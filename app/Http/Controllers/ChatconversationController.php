...
class ChatconversationController extends Controller
{
    ...
    {
        $response = Http::get("http://127.0.0.1:8021/chat/history/{$session_id}");
    ...
    public function sendMessage(Request $request)
    {
        ...
        $response = Http::asMultipart()
            ->timeout(0)
            ->post('http://127.0.0.1:8021/chat', $formData);
    ...
    public function deleteSession($session_id)
    {
        ...
        try {
            ...
            $response = Http::delete("http://127.0.0.1:8021/sessions/{$userId}/{$session_id}");
