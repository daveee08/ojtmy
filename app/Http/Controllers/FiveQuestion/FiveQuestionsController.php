...
class FiveQuestionsController extends Controller
{
    ...
    {
        $userId = Auth::id();
        $response = Http::get("http://192.168.50.40:8008/sessions/$userId"); // Adjusted URL to match your FastAPI endpoint
    ...
    public function processForm(Request $request)
    {
        ...
        $response = Http::timeout(0)
            ->asMultipart()
            ->post('http://192.168.50.40:8008/five_questions', $multipartData);  // Adjusted URL to match your FastAPI endpoint
